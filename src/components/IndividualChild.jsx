...
const IndividualChild = ({ recipe }) => {
  return (
    <div className="grid gap-4 animate__animated animate__zoomIn border m-2 w-[95%] md:w-[98%]  lg:w-[85%] xl:w-[75%] md:grid-cols-12 mx-auto shadow-xl">
      <img
        src={recipe.image}
        loading="lazy"
        alt="recipe image"
...
export default React.memo(IndividualChild);
